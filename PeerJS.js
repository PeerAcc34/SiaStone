                  ...
                  waitUntil()
                    ...
                    .done(function(result) {
                      ...
                      if (result === true) {
                        ...
                        //Check to ensure the number of files being downloaded/transferred
                        //does not exceed the limit and overwhelm the Sharer computer
                        var bufSize = 0;
...

                        {
                          ...
                          //Get the file size of the file being transferred
